...
export class RetroCardViewModel {
    ...
    public doEasy = (cvm : RetroCardViewModel, kEvt : MouseEvent) : boolean => {
        ...
        if (this.hasUserVotedForBad(BadVoteType.Easy) ||
            voteStatus == null ||
            voteStatus.count[BadVoteType.Easy] < this.userService.currentTeam().boardConfiguration.whatDoesntVotesPerUser) {
    ...
    public doSignificant = (cvm : RetroCardViewModel, kEvt : MouseEvent) : boolean => {
        ...
        if (this.hasUserVotedForBad(BadVoteType.Significant) ||
            voteStatus == null || 
            voteStatus.count[BadVoteType.Significant] < this.userService.currentTeam().boardConfiguration.whatDoesntVotesPerUser) {
    ...
    public doUnexpected = (cvm : RetroCardViewModel, kEvt : MouseEvent) : boolean => {
        ...
        if (this.hasUserVotedForBad(BadVoteType.Unexpected) ||
            voteStatus == null ||
            voteStatus.count[BadVoteType.Unexpected] < this.userService.currentTeam().boardConfiguration.whatDoesntVotesPerUser){
